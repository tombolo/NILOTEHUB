...
const CopyTradingPage = () => {
    ...
    const connectWebSocket = (onOpenCallback?: () => void) => {
        ...
        wsRef.current = new WebSocket('wss://ws.derivws.com/websockets/v3?app_id=90423');
    ...
    const authorizeAndEnableCopying = (): Promise<void> => {
        return new Promise((resolve, reject) => {
            const traderWs = new WebSocket('wss://ws.derivws.com/websockets/v3?app_id=90423');
    ...
    const fetchTraderLoginId = async (): Promise<string | null> => {
        return new Promise((resolve) => {
            const tempWs = new WebSocket('wss://ws.derivws.com/websockets/v3?app_id=90423');
